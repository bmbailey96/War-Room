...
10. COVERAGE MATCHUP is an inferred likely assignment from current depth metadata plus actual defender coverage results. Respect assignmentConfidence and the APPLIED/INFO gate. Never turn it into a claimed shadow assignment unless current reporting explicitly confirms one.
